            ...
            <div class="card glass-panel border-0 p-4 p-md-5">
                <div class="d-flex justify-content-between align-items-center mb-4 border-bottom border-secondary border-opacity-25 pb-3">
                    <h3 class="text-white m-0">
                        <i class="fa-solid fa-user-shield text-success me-2"></i>Privacy Policy
                    </h3>
                ...
                <div class="text-secondary leading-relaxed">
                    <?php if (!empty($privacy_policy)): ?>
                        <div class="policy-content text-white-50">
                            <?= nl2br(htmlspecialchars($privacy_policy)) ?>
                        </div>
                    <?php else: ?>
                        <div class="text-center py-5">
                            <i class="fa-solid fa-file-shield text-muted fa-3x mb-3"></i>
                            <p class="text-secondary mb-0">The NVOTS Platform Privacy Policy is currently being updated by the Federal Registry administration. Please check back later.</p>
                        </div>
                    <?php endif; ?>
                </div>
